...
int main() {
    ...
    struct door door_1 = {0, 1};        // создание новой двери
    ...
    struct door door2 = {1, 1};                        // создие новой двери
    ...
    struct node *node_ptr = root;  // создание указателя на корень

    root = remove_door(node_ptr, root);  // удаление двери
    print_doors_list(root);
